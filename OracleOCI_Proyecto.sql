...
GRANT EXECUTE ON SYS.DBMS_RLS TO admin_constru ;
GRANT EXECUTE ON SYS.DBMS_RLS TO gerente;
GRANT EXECUTE ON SYS.DBMS_RLS TO operador;
...
----- se ejecuta en Proyecto -----





-- Monitorear espacio libre en los Tablespaces
